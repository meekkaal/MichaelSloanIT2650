...
public class Chapter3Problem5
{
  ...
  public static void main(String[] args)
  {
    ...
    System.out.printf("%n%-15s%-15s%-15s%-15s%-15s %n", "Month", "Monthly", "Interest", "Principal", "Remaining");
    System.out.printf("%-15s%-15s%-15s%-15s%-15s  %n%n", "Number", "Pymt", "Paid", "Paid", "Balance");
